...
from torch.utils.data import RandomSampler,DataLoader, \
    DistributedSampler,SequentialSampler,random_split
...
def train(args, train_dataset, model, tokenizer):
    ...
    set_random_seed(seed=args.seed,no_cuda=args.no_cuda)  # Added here for reproductibility (even between python 2 and 3)
